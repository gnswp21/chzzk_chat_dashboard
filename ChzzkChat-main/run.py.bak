...
if __name__ == '__main__':
    ...
    # streamer_name = api.fetch_channelName('소니쇼')
    # print(streamer_name)
    # streamer_id = api.fetch_chatChannelId(streamer=streamer_name, cookies=cookies)
    streamer_id =  'cd04c50c6ff488ac96f8900e26e5b993'
